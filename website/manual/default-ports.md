...
| :---------- | :-----------: | :-----------: | :---: | :------: | :--------------------------------------: |
| k8s-gateway |     main      |     main      |  53   |   UDP    |  Potential conflict with other DNS apps  |
...
| pihole                     |     dns-tcp     |     dns-tcp     |  53   |   TCP    | Potential conflict with other DNS apps  |
| pihole                     |       dns       |       dns       |  53   |   UDP    | Potential conflict with other DNS apps  |
| technitium                 |     dns-tcp     |     dns-tcp     |  53   |   TCP    | Potential conflict with other DNS apps  |
| technitium                 |     dns-udp     |     dns-udp     |  53   |   UDP    | Potential conflict with other DNS apps  |
| mosdns                     |     dns-udp     |     dns-udp     |  53   |   UDP    | Potential conflict with other DNS apps  |
| adguard-home               |     dns-tcp     |     dns-tcp     |  53   |   TCP    | Potential conflict with other DNS apps  |
| adguard-home               |     dns-udp     |     dns-udp     |  53   |   UDP    | Potential conflict with other DNS apps  |
...
| technitium                 |     dns-tls     |     dns-tls     |  853  |   TCP    |  Potential conflict with adguard-home   |
